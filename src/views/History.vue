              ...
              <md-table-body>
                ...
                <md-table-row style="text-align:center;" v-for="(row, index) in contagion_list" :key="index" md-numeric>
                  ...
                  <md-table>
                    <md-table-header>
                      <md-table-row>
                        <md-table-head md-numeric style="text-align:center;">是否隔离</md-table-head>
                        <md-table-head md-numeric style="text-align:center;">隔离地点</md-table-head>
                      </md-table-row>
                    </md-table-header>
                    <md-table-body>
                      <md-table-row style="text-align:center;" v-for="(row, index) in contagion_list" :key="index" md-numeric>
                        <md-table-cell style="text-align:center;" md-numeric>{{row.separate}}</md-table-cell>
                        <md-table-cell style="text-align:center;" md-numeric>{{row.separate_place}}</md-table-cell>
                      </md-table-row>
                    </md-table-body>
                  </md-table>
                </md-table-row>
                <md-table-row style="text-align:center;" v-for="(row, index) in contagion_list" :key="index" md-numeric>
                  ...
                  <md-table>
                    <md-table-header>
                      <md-table-row>
                        <md-table-head md-numeric style="text-align:center;">是否离校</md-table-head>
                        <md-table-head md-numeric style="text-align:center;">是否返校</md-table-head>
                        <md-table-head md-numeric style="text-align:center;">返校时间</md-table-head>
                      </md-table-row>
                    </md-table-header>
                    <md-table-body>
                      <md-table-row style="text-align:center;" v-for="(row, index) in contagion_list" :key="index" md-numeric>
