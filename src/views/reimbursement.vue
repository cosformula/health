<template>
  <div class="hello">
    <md-table>
      <md-table-header>
        <md-table-row >
          <md-table-head class="table_header" style="text-align:center;">学号/工号</md-table-head>
...
<br/><br/><p style="margin-left:30px">报销记录</p>
    <md-table v-once>
  <md-table-header>
    <md-table-row>
      ...
      <md-table-head md-numeric style="text-align:center;">报销金额</md-table-head>
