<template>
    ...
    <md-dialog md-open-from="#custom" md-close-to="#custom" ref="dialog1">
      ...
      <md-dialog-actions>
        <md-button class="md-primary" @click.native="closeDialog('dialog1')">确认</md-button>
      </md-dialog-actions>
    </md-dialog>
    <md-dialog md-open-from="#custom" md-close-to="#custom" ref="dialog2">
      ...
      <md-dialog-content>
        <md-table style="width:100%;margin-top:20px;">
          ...
          <md-table-body>
            <md-table-cell style="text-align:center;" md-numeric>{{current_item.medical_name}}</md-table-cell>
            <md-table-cell style="text-align:center;" md-numeric>{{current_item.method}}</md-table-cell>
          </md-table-body>
        </md-table>
      </md-dialog-content>
