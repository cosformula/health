        ...
        <md-table style="width:100%;margin-left:auto;margin-right:auto;">
          ...
          <md-table-body>
            <md-table-row style="text-align:center;"
                          v-for="(row, index) in doctor_list"
                          :key="index"
                          md-numeric>
            ...
            <md-table-row style="text-align:center;"
              ...
              <md-table-cell style="text-align:center;"
                             md-numeric>{{row.department}}</md-table-cell>
            </md-table-row>
            <md-table-row style="text-align:center;"
                          v-for="(row, index) in doctor_list"
                          :key="index"
              ...
              <md-table>
                ...
                <md-table-body>
                  <md-table-row style="text-align:center;"
                                ...
                                md-numeric>
                    <md-table-cell style="text-align:center;"
                                   md-numeric>{{row.total_fees}}</md-table-cell>
                    <md-table-cell style="text-align:center;"
                                   md-numeric>{{row.real_fees}}</md-table-cell>
                  </md-table-row>
                </md-table-body>
              </md-table>
            </md-table-row>
            <md-table-row style="text-align:center;"
              ...
              <md-table-cell style="text-align:center;"
                ...
                <md-button class="md-raised"
                           @click.native="openDialog('dialog1', index)"
                           style="width:60%;">病状</md-button>
                <md-button class="md-raised"
                           @click.native="openDialog('dialog2', index)"
                           style="width:60%;">处方</md-button>
              </md-table-cell>
            </md-table-row>
          </md-table-body>
        </md-table>
